...
namespace WpfExample
{
    ...
    {
        private Action<object> execute; private Predicate<object> canExecute; private event EventHandler CanExecuteChangedInternal;
        ...
        {
            add
            { CommandManager.RequerySuggested += value; this.CanExecuteChangedInternal += value; }
